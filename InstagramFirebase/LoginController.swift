...
class LoginController: UIViewController {
    ...
    let dontHaveAccountBotton: UIButton = {
        let button = UIButton(type: .system)
    ...
    override func viewDidLoad() {
        ...
        view.addSubview(dontHaveAccountBotton)
        dontHaveAccountBotton.anchor(top: nil, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 50)
