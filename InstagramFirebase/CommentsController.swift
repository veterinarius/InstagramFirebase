...
//  InstagramFirebase
//
//  Created by Stephan Wegmann on 03.10.18.
...
class CommentsController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    lazy var containerView: UIView = {
        ...
        submitButton.setTitle("Senden", for: .normal)
    ...
    let commentTextField: UITextField = {
        ...
        textField.placeholder = "Dein Kommentar..."
        return textField
    }()
    ...
    @objc func handleSubmit() {
        ...
        print("Kommentar gesendet:", commentTextField.text ?? "")
        ...
        FIRDatabase.database().reference().child("comments").child(postId).childByAutoId().updateChildValues(values) { (err, ref) in
            ...
            if let err = err {
                print("Eingabe fehlgeschlagen!", err)
                return
            }
